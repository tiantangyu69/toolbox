...
public class EncryptPBE {
	...
	public static String encryptPBE(String src, String pwd, byte[] salt)
		...
		byte[] data = EncryptPBE.encrypt(input, pwd, salt);

		return new String(EncryptBase64.encode(data));
	...
	public static String decryptPBE(String src, String pwd, byte[] salt)
		...
		byte[] output = EncryptPBE.decrypt(EncryptBase64.decode(src).getBytes(), pwd, salt);
